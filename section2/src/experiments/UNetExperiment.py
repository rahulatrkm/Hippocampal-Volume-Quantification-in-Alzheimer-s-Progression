...
class UNetExperiment:
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # ANSWER: The three dimensions represents the hippocampal volume, remaining represents the batch for training and testing the model.
    ...
    def validate(self):
        ...
        with torch.no_grad():
            for i, batch in enumerate(self.val_loader):
                ...
                loss = self.loss_function(pred, target[:, 0, :, :].to(self.device))
